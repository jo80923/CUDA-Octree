...
* \{
*/
void remove(jax::Unity<float2_b>* array);
void remove(jax::Unity<float3_b>* array);
void remove(jax::Unity<float4_b>* array);
void remove(jax::Unity<double2_b>* array);
void remove(jax::Unity<double3_b>* array);
void remove(jax::Unity<double4_b>* array);
void remove(jax::Unity<char2_b>* array);
void remove(jax::Unity<char3_b>* array);
void remove(jax::Unity<char4_b>* array);
void remove(jax::Unity<uchar2_b>* array);
void remove(jax::Unity<uchar3_b>* array);
void remove(jax::Unity<uchar4_b>* array);
void remove(jax::Unity<short2_b>* array);
void remove(jax::Unity<short3_b>* array);
void remove(jax::Unity<short4_b>* array);
void remove(jax::Unity<ushort2_b>* array);
void remove(jax::Unity<ushort3_b>* array);
void remove(jax::Unity<ushort4_b>* array);
void remove(jax::Unity<int2_b>* array);
void remove(jax::Unity<int3_b>* array);
void remove(jax::Unity<int4_b>* array);
void remove(jax::Unity<uint2_b>* array);
void remove(jax::Unity<uint3_b>* array);
void remove(jax::Unity<uint4_b>* array);
void remove(jax::Unity<long2_b>* array);
void remove(jax::Unity<long3_b>* array);
void remove(jax::Unity<long4_b>* array);
void remove(jax::Unity<ulong2_b>* array);
void remove(jax::Unity<ulong3_b>* array);
void remove(jax::Unity<ulong4_b>* array);
void remove(jax::Unity<longlong2_b>* array);
void remove(jax::Unity<longlong3_b>* array);
void remove(jax::Unity<longlong4_b>* array);
void remove(jax::Unity<ulonglong2_b>* array);
void remove(jax::Unity<ulonglong3_b>* array);
void remove(jax::Unity<ulonglong4_b>* array);
/**
* \}
* \ingroup cuda_util
