...
void remove(jax::Unity<float2_b>* array){remove(array,check_if_valid<float2_b>);}
void remove(jax::Unity<float3_b>* array){remove(array,check_if_valid<float3_b>);}
void remove(jax::Unity<float4_b>* array){remove(array,check_if_valid<float4_b>);}
void remove(jax::Unity<double2_b>* array){remove(array,check_if_valid<double2_b>);}
void remove(jax::Unity<double3_b>* array){remove(array,check_if_valid<double3_b>);}
void remove(jax::Unity<double4_b>* array){remove(array,check_if_valid<double4_b>);}
void remove(jax::Unity<char2_b>* array){remove(array,check_if_valid<char2_b>);}
void remove(jax::Unity<char3_b>* array){remove(array,check_if_valid<char3_b>);}
void remove(jax::Unity<char4_b>* array){remove(array,check_if_valid<char4_b>);}
void remove(jax::Unity<uchar2_b>* array){remove(array,check_if_valid<uchar2_b>);}
void remove(jax::Unity<uchar3_b>* array){remove(array,check_if_valid<uchar3_b>);}
void remove(jax::Unity<uchar4_b>* array){remove(array,check_if_valid<uchar4_b>);}
void remove(jax::Unity<short2_b>* array){remove(array,check_if_valid<short2_b>);}
void remove(jax::Unity<short3_b>* array){remove(array,check_if_valid<short3_b>);}
void remove(jax::Unity<short4_b>* array){remove(array,check_if_valid<short4_b>);}
void remove(jax::Unity<ushort2_b>* array){remove(array,check_if_valid<ushort2_b>);}
void remove(jax::Unity<ushort3_b>* array){remove(array,check_if_valid<ushort3_b>);}
void remove(jax::Unity<ushort4_b>* array){remove(array,check_if_valid<ushort4_b>);}
void remove(jax::Unity<int2_b>* array){remove(array,check_if_valid<int2_b>);}
void remove(jax::Unity<int3_b>* array){remove(array,check_if_valid<int3_b>);}
void remove(jax::Unity<int4_b>* array){remove(array,check_if_valid<int4_b>);}
void remove(jax::Unity<uint2_b>* array){remove(array,check_if_valid<uint2_b>);}
void remove(jax::Unity<uint3_b>* array){remove(array,check_if_valid<uint3_b>);}
void remove(jax::Unity<uint4_b>* array){remove(array,check_if_valid<uint4_b>);}
void remove(jax::Unity<long2_b>* array){remove(array,check_if_valid<long2_b>);}
void remove(jax::Unity<long3_b>* array){remove(array,check_if_valid<long3_b>);}
void remove(jax::Unity<long4_b>* array){remove(array,check_if_valid<long4_b>);}
void remove(jax::Unity<ulong2_b>* array){remove(array,check_if_valid<ulong2_b>);}
void remove(jax::Unity<ulong3_b>* array){remove(array,check_if_valid<ulong3_b>);}
void remove(jax::Unity<ulong4_b>* array){remove(array,check_if_valid<ulong4_b>);}
void remove(jax::Unity<longlong2_b>* array){remove(array,check_if_valid<longlong2_b>);}
void remove(jax::Unity<longlong3_b>* array){remove(array,check_if_valid<longlong3_b>);}
void remove(jax::Unity<longlong4_b>* array){remove(array,check_if_valid<longlong4_b>);}
void remove(jax::Unity<ulonglong2_b>* array){remove(array,check_if_valid<ulonglong2_b>);}
void remove(jax::Unity<ulonglong3_b>* array){remove(array,check_if_valid<ulonglong3_b>);}
void remove(jax::Unity<ulonglong4_b>* array){remove(array,check_if_valid<ulonglong4_b>);}
